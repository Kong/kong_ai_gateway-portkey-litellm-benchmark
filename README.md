...
All AI Gateway deployments had the resource configuration with an upper limit of 12 CPUs. They were deployed with the default configuration, meaning they were not tunned to get better results.
